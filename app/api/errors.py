...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def _422_start(_: Request, exc: de.InvalidStartMessage):
        return JSONResponse(status_code=st.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    async def _404_not_found(_: Request, exc: de.ConversationNotFound):
        return JSONResponse(status_code=st.HTTP_404_NOT_FOUND,
                            content={"detail": exc.message})
    ...
    async def _503_timeout(_: Request, exc: de.LLMTimeout):
        return JSONResponse(status_code=st.HTTP_503_SERVICE_UNAVAILABLE,
                            content={"detail": exc.message})
    ...
    async def _502_llm(_: Request, exc: de.LLMServiceError):
        ...
        return JSONResponse(status_code=st.HTTP_502_BAD_GATEWAY,
                            content={"detail": exc.message})
