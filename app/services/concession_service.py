...
class ConcessionService:
    ...
    async def analyze_conversation(
        ...
        last_two_eval = self.judge_last_two_messages(
    ...
    def judge_last_two_messages(
        ...
        return {
            ...
            + (
                ['pairwise_opposition']
                if reason == 'thesis_opposition'
                and pair_scores['contradiction'] >= self.contradiction_threshold
                else []
            ),
            'scores': pair_scores,
    ...
    def nli_confident(
        self, scores: Dict[str, float], *, pmin=0.75, margin=0.15
    ) -> bool:
